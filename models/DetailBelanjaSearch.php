...
/**
 * DetailBelanjaSearch represents the model behind the search form of `app\models\DetailBelanja`.
 */
class DetailBelanjaSearch extends DetailBelanja
{
    /**
     * {@inheritdoc}
     */
