...
/**
 * DetailPergeseranSearch represents the model behind the search form of `app\models\DetailPergeseran`.
 */
class DetailPergeseranSearch extends DetailPergeseran
{
    /**
     * {@inheritdoc}
     */
