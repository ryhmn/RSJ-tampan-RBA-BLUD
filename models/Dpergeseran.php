 ...
 *
 * @property Dbelanja $detailBelanja
 * @property Pergeseran $pergeseran
 * @property Satuan $satuan
 */
class Dpergeseran extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['detail_belanja_id'], 'exist', 'skipOnError' => true, 'targetClass' => Dbelanja::class, 'targetAttribute' => ['detail_belanja_id' => 'detail_belanja_id']],
    ...
    {
        return $this->hasOne(Dbelanja::class, ['detail_belanja_id' => 'detail_belanja_id']);
    }
